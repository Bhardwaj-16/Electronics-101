...
* [Simulating Circuits](#simulating-circuits)
  ...
  * [Meet Falstad](#meet-falstad)
  * [First Component: Voltage Source (The Push)](#first-component-voltage-source-the-push)
  * [Resistors](#resistors)
  * [LEDs](#leds)
  * [Capacitors: Storing Electrical Pressure](#capacitors-storing-electrical-pressure)
  * [How RC Circuits Control Time](#how-rc-circuits-control-time)
* [Make Something Cool!?](#make-something-cool)
...
The goal is to not let ideas get too abstract here.
...
<img width="839" height="364" alt="image" src="https://github.com/user-attachments/assets/91dcc4c2-7db1-4c4d-ab6f-8c8ad8f9ff37" />
...
<img width="500" height="448" alt="image" src="https://github.com/user-attachments/assets/dbd82cfd-9158-4651-9552-e3b21426abdd" />

*A modern through-hole transistor*

<img width="516" height="397" alt="image" src="https://github.com/user-attachments/assets/ff976f73-512f-4e8e-bb7b-2dd9d4ac9465" />
...
<img width="1849" height="1057" alt="Falstad Circuit Simulator interface" src="https://github.com/user-attachments/assets/6b1356cb-c816-4556-9a37-0440724e6dc7" />
...
<img width="680" height="496" alt="Voltage and current scope in Falstad" src="https://github.com/user-attachments/assets/85db30d5-3d7a-4881-b7c4-38a8b6b834b7" />
...
**voltage source → switch → LED (line side to ground) → back to voltage source**

Hit **Run**. Flip the switch closed and the LED should glow red! If not, the green dots stop at the LED. That's the diode teaching you about direction. Flip the LED around and try again.
...
**Try this:** Voltage source → switch → resistor → LED → ground, *plus* capacitor across the LED. Close the switch. Now notice how when you close and then open the switch the LED gradually dims instead of just

<img width="602" height="359" alt="Capacitor and LED circuit" src="https://github.com/user-attachments/assets/1a11872d-7508-435b-af92-06691258da39" />
